...
WorkspacePath          :="C:/Users/Elias/OneDrive - Chalmers Students/Documents/Studies/Programing/mop/cWorkSpace/cWorkSpace"
ProjectPath            :="C:/Users/Elias/OneDrive - Chalmers Students/Documents/Studies/Programing/mop/cWorkSpace/cWorkSpace/snake"
...
Objects0=$(IntermediateDirectory)/ascii_display.c$(ObjectSuffix) $(IntermediateDirectory)/counting_circuits.c$(ObjectSuffix) $(IntermediateDirectory)/keypad.c$(ObjectSuffix) $(IntermediateDirectory)/init.c$(ObjectSuffix) $(IntermediateDirectory)/game.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/ascii_display.c$(ObjectSuffix): ascii_display.c
	...
	$(CC) $(SourceSwitch) "C:/Users/Elias/OneDrive - Chalmers Students/Documents/Studies/Programing/mop/cWorkSpace/cWorkSpace/snake/ascii_display.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ascii_display.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/counting_circuits.c$(ObjectSuffix): counting_circuits.c
	...
	$(CC) $(SourceSwitch) "C:/Users/Elias/OneDrive - Chalmers Students/Documents/Studies/Programing/mop/cWorkSpace/cWorkSpace/snake/counting_circuits.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/counting_circuits.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/keypad.c$(ObjectSuffix): keypad.c
	...
	$(CC) $(SourceSwitch) "C:/Users/Elias/OneDrive - Chalmers Students/Documents/Studies/Programing/mop/cWorkSpace/cWorkSpace/snake/keypad.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/keypad.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/init.c$(ObjectSuffix): init.c
	...
	$(CC) $(SourceSwitch) "C:/Users/Elias/OneDrive - Chalmers Students/Documents/Studies/Programing/mop/cWorkSpace/cWorkSpace/snake/init.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/init.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/game.c$(ObjectSuffix): game.c
	...
	$(CC) $(SourceSwitch) "C:/Users/Elias/OneDrive - Chalmers Students/Documents/Studies/Programing/mop/cWorkSpace/cWorkSpace/snake/game.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/game.c$(ObjectSuffix) $(IncludePath)
